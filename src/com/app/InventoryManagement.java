...
import com.app.InventoryResult;
...
//Declaration and Initializing the Objects
    ...
    private static InventoryResult getRiceInventoryResult(JSONArray riceInventory) throws IOException {
...

        {
            ...
            riceInventoryResult.setTotalPrice(riceInventoryResult.getTotalPrice() + (rice.getWeight() * rice.getPricePerKg()));
    ...
    private static InventoryResult getPulseInventoryResult(JSONArray pulseInventory) throws IOException {
...

        {
            ...
            pulseInventoryResult.setTotalPrice(pulseInventoryResult.getTotalPrice() + (pulse.getWeight() * pulse.getPricePerKg()));
    ...
    private static InventoryResult getWheatInventoryResult(JSONArray wheatInventory) throws IOException {
...

        {
            ...
            wheatInventoryResult.setTotalPrice(wheatInventoryResult.getTotalPrice() + (wheat.getWeight() * wheat.getPricePerKg()));
